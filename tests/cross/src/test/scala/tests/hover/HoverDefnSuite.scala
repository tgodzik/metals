...
class HoverDefnSuite extends BaseHoverSuite {
  ...
  check(
    ...
    """|def empty[T]: Option[T]
       |""".stripMargin.hover,
    compat = Map(
      "0.22" -> "def empty[T] => Option[T]".hover
    )
  )
  ...
  check(
    ...
    """
      ...
      |""".stripMargin.hover,
    compat = Map(
      "0.22" -> "def empty[T](implicit evidence$1: Ordering[T]): Option[T]".hover
    )
  )
  ...
  check(
    ...
    """|```scala
       ...
       |""".stripMargin,
    compat = Map(
      "0.22" -> "def <init>(x: Int): ctor.a".hover
    )
  )
  ...
  check(
    ...
    "",
    compat = Map(
      "0.22" -> "object MyObject$: object.MyObject$".hover
    )
  )
  ...
  check(
    ...
    "",
    compat = Map(
      "0.22" -> "trait MyTrait: trait.MyTrait".hover
    )
  )
  ...
  check(
    ...
    "",
    compat = Map(
      "0.22" -> "trait MyClass: class.MyClass".hover
    )
  )
