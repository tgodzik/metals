object TestGroups {
  ...
  val allTests = List(
    ...
    "tests.DebugProtocolSuite", "tests.BillLspSuite", "tests.CodeLensLspSuite",
    "tests.codeactions.ImportMissingSymbolLspSuite", "tests.debug.StepDapSuite",
    "tests.debug.StackFrameDapSuite", "tests.FormattingLspSuite",
    "tests.NewFileLspSuite", "tests.CascadeLspSuite",
    "tests.DiagnosticsLspSuite",
    "tests.worksheets.WorksheetNoDecorationsLspSuite",
    "tests.CompletionLspSuite", "tests.TreeViewLspSuite", "tests.HoverLspSuite",
    "tests.SuperHierarchyLspSuite", "tests.DidFocusLspSuite",
    "tests.BuildServerConnectionLspSuite", "tests.BuildTargetsLspSuite",
    "tests.FileWatcherLspSuite", "tests.CurrentProjectCompileLspSuite",
    ...
    "tests.SuperMethodSuite", "tests.StatusBarSuite", "tests.CompressionSuite",
    ...
    "tests.debug.BreakpointDapSuite", "tests.OnTypeFormattingSuite",
    ...
    "tests.rangeFormatting.IndentWhenPastingSuite", "tests.DebugDiscoverySuite",
    "tests.SemanticdbScala2Suite", "tests.codeactions.OrganizeImportsLspSuite",
    ...
    "tests.codeactions.MillifyDependencyLspSuite", "tests.RenameFilesLspSuite",
    "tests.codeactions.ExtractMethodLspSuite",
  ...
  val testGroups: List[Set[String]] = allTests
