...
// TODO move unneded method to SyntheticsDecorationPRovider
abstract class Decorations[T](
  ...
  protected def currentDocument(path: AbsolutePath): Option[TextDocument] = {
