...
/**
 * The interface for the presentation compiler to extract symbol documentation and perform fuzzy
 * symbol search.
 */
public interface SymbolSearch {
  ...
  /** Returns the documentation of this symbol, if any. */
  default Optional<SymbolDocumentation> documentation(
      String symbol, ParentSymbols parents, ContentType contentType) {
  ...
  /**
   * Returns the all symbols in the file where the given symbol is defined in declaration order, if
   * any.
   */
